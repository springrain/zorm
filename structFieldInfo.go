	...
	for i, columnType := range columnTypes {
		...
		if iscdvm {
			if fieldCache.customDriverValueConver == nil {
				fieldCache.customDriverValueConver = customDriverValueMap[fieldCache.dialectDatabaseTypeName]
			}
			if fieldCache.customDriverValueConver == nil {
				fieldCache.customDriverValueConver = customDriverValueMap[fieldCache.databaseTypeName]
			}
		}
