## 介绍
go(golang)轻量级ORM,支持达梦(dm),人大金仓(kingbase),神通(shentong),mysql,postgresql,oracle,mssql,sqlite数据库.  
...
### 神州通用(shentong)  
建议使用官方的aci驱动,配置zorm.DataSourceConfig的 DriverName:aci ,DBType:shentong  
